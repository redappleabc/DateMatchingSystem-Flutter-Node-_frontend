...
class _Question2ScreenState extends State<Question2Screen> {
  ...
  Future getAnswer() async{
    setState(() {
      String answer = Provider.of<UserState>(context, listen: false).user!.questions![1];
  ...
  Future saveAnswer () async{
    bool isSaved = await Provider.of<UserState>(context, listen: false).saveQuestionAnswer(answerController.text, 2);
    if(isSaved){
