...
class MemoryDescriptionWidget extends StatefulWidget {
  const MemoryDescriptionWidget({super.key});

  @override
  State<MemoryDescriptionWidget> createState() => _MemoryDescriptionWidgetState();
}

class _MemoryDescriptionWidgetState extends State<MemoryDescriptionWidget> {
