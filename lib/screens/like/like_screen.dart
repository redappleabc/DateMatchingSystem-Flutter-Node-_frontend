...
class _LikeListScreenState extends State<LikeListScreen> {
    ...
    if (result) {
      ...
      setState(() {
        ...
        if (likes.isEmpty) {
          ...
          currenIndex =
              (currenIndex >= likes.length) ? likes.length - 1 : currenIndex;
        }
      });
    }
  }
  ...
  Future thanksClick(int id, String avatar, String name) async {
    ...
    Navigator.pushNamed(context, "/likematching_complete",
        arguments: MatchingModel(id: id, avatar: avatar, name: name));
  }
                  ...
                  children: [
                        ...
                        child: CustomContainer(
                            ...
                            child: Center(
                              child: Container(
                                ...
                                height: 215,
                                padding:
                                    const EdgeInsets.only(top: 46, bottom: 26),
                                decoration: BoxDecoration(
                                  color: AppColors.primaryWhite,
                                  borderRadius: BorderRadius.circular(10),
                                  boxShadow: [
                    ...
                    Center(
                      child: CustomContainer(
                        height: 94,
                        decoration:
                            BoxDecoration(color: AppColors.secondaryGreen),
                        child: Padding(
