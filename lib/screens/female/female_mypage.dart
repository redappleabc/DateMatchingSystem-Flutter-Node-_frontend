  ...
  Widget CenterCard() {
    if (!user.isVerify) {
                  ...
                  children: [
                    Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: const DecorationImage(
                                image:
                                    AssetImage("assets/images/verify_icon.png"),
                                fit: BoxFit.contain))),
                    const SizedBox(
                      width: 18,
                    ),
      ...
      return Container(
        width: MediaQuery.of(context).size.width,
        padding:
            const EdgeInsets.only(top: 26, left: 18, right: 18, bottom: 20),
        decoration: BoxDecoration(
          gradient: LinearGradient(
            begin: Alignment.topLeft,
            end: Alignment.topRight,
          ...
          children: [
            Row(
              ...
              children: [
                Row(
                  children: [
                    ImageIcon(const AssetImage("assets/images/message.png"),
                        color: AppColors.primaryWhite),
                    const SizedBox(
                      width: 18,
                    ),
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.only(top: 40, bottom: 23),
                              child: Wrap(
