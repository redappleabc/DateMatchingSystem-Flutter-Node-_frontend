  ...
  Widget build(BuildContext context) {
    return BaseScreen(
      ...
      children: [
        CustomContainer(
          decoration:
              BoxDecoration(color: AppColors.primaryGray.withOpacity(0.5)),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Image.asset("assets/images/limit.png",
                                              fit: BoxFit.cover),
                                          const SizedBox(
                                            width: 22,
                                          ),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Image.asset(
                                              "assets/images/first_profile.png",
                                              fit: BoxFit.cover),
                                          const SizedBox(
                                            width: 22,
                                          ),
                                ...
                                CustomText(
                                    text:
                                        "お試しプランはいつでも解約手続きすることができ期間内であれば登録料や解約料はかかりません。",
                                    fontSize: 12,
                                    fontWeight: FontWeight.normal,
                                    lineHeight: 2,
                                    letterSpacing: -1,
